    ...
    <div className="flex flex-col gap-6 items-center">
      ...
      <div className="flex flex-col items-center">
        <Card className="flex w-11/12 max-w-xl">
          {
            methodMenu.map((methodName, index) => <Button size="large" variant="contained" className={`text-black w-1/3 h-16 m-1 ${method == (index) ? "bg-green-400 hover:bg-green-300" : "hover:bg-green-300"}`} onClick={() => setMethod(index)}>{methodName}</Button>)
          }
        </Card>
