          ...
          >
            <Box sx={style}>
              <Typography id="modal-modal-title" variant="h6" component="h2"
                          className="text-black text-center text-1xl font-bold">
                Before use one point iteration method
              </Typography>
              <Typography id="modal-modal-description" sx={{ mt: 2 }}
                          className="text-black">
                You need to reform the equation in form x = f(x) <br/> <span className="font-black">Example</span> <br/>
              ...
              <div className="w-full pt-4
                ...
                <Button onClick={handleClose}
                        className="bg-green-600 text-white
                                    hover:bg-green-300">Understood</Button>
              </div>
            </Box>
          </Modal>
        </div>
